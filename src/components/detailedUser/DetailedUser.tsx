...
import { fetchUserDetailPage } from "../../utils/apiService.ts";
import "./index.css";
          ...
          <div className="avatar">
            ...
            <Flex gap="2">
              <Avatar
                ...
                fallback={`${detailedUser[0].name.charAt(0).toLocaleUpperCase()}`}
              />
            </Flex>
          </div>
          ...
          <div className="user-details">
            <div className="detail-row">
              ...
              <div className="detail-item">
                ...
                <span>{detailedUser[0]?.username}</span>
              </div>
            </div>
            <div className="detail-row">
              <div className="detail-item">
            ...
            <div className="detail-row">
              ...
              <div className="detail-item">
                <strong>City</strong>{" "}
                <span>{detailedUser[0]?.address?.city}</span>
              </div>
            </div>
            <div className="detail-row">
              <div className="detail-item">
